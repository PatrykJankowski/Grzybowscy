    ...
    <div class="header__top">
        <div class="container">
            <div class="header__contact-wrapper header__contact-wrapper--first">
                <svg class="header__contact-icon" fill="#fff" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 401.998 401.998" xml:space="preserve">
                    <g>
